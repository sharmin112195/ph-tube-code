              ...
              <div class="flex items-center gap-2">
                 <p class="text-gray-400">${video.authors[0].profile_name}</p>
                   ${
                     ...
                     ${
                        video.others.posted_date?.length == 0 ? "":`<span class="absolute right-3 bottom-24 bg-black rounded p-1 text-white text-xs">${getTimeString(video.others.posted_date)}</span>`
                      }
                  
       </div> 

            <p><button onclick="loadDetails('${video.video_id}')" class="btn btn-sm btn-accent">details</button></p>
